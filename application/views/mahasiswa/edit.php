                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?=$mahasiswa['nim'] ?>" type="number" class="form-control" id="nim" name="nim">
                                <div id="emailHelp" class="form-text text-danger"><?=form_error('nim') ?></div>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input value="<?=$mahasiswa['email'] ?>" type="text" class="form-control" id="email" name="email">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="prodi" id="prodi" class="form-select">
                                    <?php foreach($prodi as $p) : ?>
                                        <option value="<?=$p['id'] ?>" <?= $p['id'] == $mahasiswa['prodi_id'] ? 'selected' : '' ?> ><?=$p['nama'] ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
